<div align="center">
  <img src="./assets/hero.svg" width="100%" alt="Gyan cinematic hero" />
  <br><br>
  <img src="./assets/about.svg" width="100%" alt="About Gyan" />
  <br><br>
  <img src="./assets/progress.svg" width="100%" alt="Current learning progress" />
  <br><br>
  <img src="./assets/stack.svg" width="100%" alt="Tech stack" />
  <br><br>
  <img src="./assets/universe-flix.svg" width="100%" alt="Featured project Universe-Flix" />
  <br>
  <a href="https://github.com/Gyan-775/Universe-flix-2.0" style="display:inline-block;margin-top:14px;padding:10px 22px;border-radius:999px;border:1px solid #67e8f9;background:linear-gradient(90deg,#0f172a,#1e1b4b);color:#e0f2fe;text-decoration:none;font-family:monospace;font-weight:700;letter-spacing:.8px;">VIEW UNIVERSE-FLIX →</a>
  <br><br>
  <img src="./assets/journey.svg" width="100%" alt="Learning journey" />
  <br><br>

  <img src="./assets/github.svg" width="100%" alt="Live GitHub dashboard frame" />
  <br><br>
